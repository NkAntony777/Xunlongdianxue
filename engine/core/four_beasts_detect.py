...
# --- scale (re-export from engine.core.scale) ---
from engine.core.scale import (  # noqa: F401,E402
    XUANWU_FRAC, SHAOZU_FRAC, SIDE_FRAC, BAIHU_FRAC, ZHUQUE_FRAC,
    SHAOZU_XUANWU_DIST_RATIO, XUANWU_MIN_FRAC, BAIHU_MIN_FRAC, SHAOZU_MIN_FRAC,
    NOISE_FLOOR_CELLS, XUANWU_DH_SWEET_M,
    XUANWU_DIST_M, ZHUQUE_DIST_M, SIDE_DIST_M, BAIHU_DIST_M, SHAOZU_DIST_M,
    noise_floor_m, estimate_site_scale_m, beast_distance_windows,
)

# locate-only constants (not scale)
...
# --- water field (re-export) ---
from engine.core.field.water_raster import (  # noqa: F401,E402
...
# --- qi field (re-export) ---
from engine.core.field.qi import (  # noqa: F401,E402
    _auto_sample_step,
    _sigmoid,
    _water_distance_plateau,
    compute_qi_field_layers,
    compute_score_grid,
    smooth_score_field,
    find_score_peak,
    score_peak_xy,
